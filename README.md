...
📂 **[Employee-Management-System](https://github.com/AbdallahHasan04/Employee-Management-System)**
...
📂 **[2D-Arcade-Style-Assembly-8086-Game](https://github.com/AbdallahHasan04/2D-Arcade-Style-Assembly-8086-Game)**
* Programmed a playable 2D arcade-style retro game in x86 Assembly language. Implemented real-time hardware input handling, custom rendering using low-level BIOS/DOS interrupts, collision detection vectors, and score tracking loops.
* *Tech Stack:* x86 Assembly
...
* *Tech Stack:* SQL, Relational Database Design

📂 **[Arduino-Smart-home-Files](https://github.com/AbdallahHasan04/Arduino-Smart-home-Files)**
* Developed an embedded hardware smart home simulation featuring automated environmental lighting controls, temperature sensing configurations, and dangerous gas/CO safety detection logic. Programmed microcontroller processing steps directly in C/C++.
* *Tech Stack:* C/C++, Arduino Hardware, Microcontrollers
